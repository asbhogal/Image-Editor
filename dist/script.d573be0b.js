...
var applyFilters = function applyFilters() {
  previewImg.style.filter = "brightness(".concat(brightness, "%) \n                                    saturate(").concat(saturation, "%) \n                                    invert(").concat(inversion, "%) \n                                    grayscale(").concat(grayscale, "%)");
  previewImg.style.transform = "rotate(".concat(rotate, "deg)\n                                    scale(").concat(flipHorizontal, ",\n                                    ").concat(flipVertical, ")");
};
...
filterOptions.forEach(function (option) {
  option.addEventListener("click", function () {
    ...
    if (option.id === "brightness") {
      ...
      filterValue.innerText = "".concat(brightness, "%");
    } else if (option.id === "saturation") {
      filterSlider.max = "200";
      filterSlider.value = saturation;
      filterValue.innerText = "".concat(saturation, "%");
    } else if (option.id === "inversion") {
      filterSlider.max = "100";
      filterSlider.value = inversion;
      filterValue.innerText = "".concat(inversion, "%");
    } else {
      filterSlider.max = "100";
      filterSlider.value = grayscale;
      filterValue.innerText = "".concat(grayscale, "%");
    }
  });
});
var updateFilter = function updateFilter() {
  filterValue.innerText = "".concat(filterSlider.value, "%");
  var selectedFilter = document.querySelector(".filter .active");
